...
public class PageBase {
    ...
    public void takeAndCompareScreenshot(String actualScreenshotName, WebElement element) throws IOException {
        ...
        ProcessBuilder pb = new ProcessBuilder(new String[]{"C:\\Users\\dushu\\OneDrive\\Документи\\ImageMagick-7.1.1-5-portable-Q8-x64\\compare.exe", "-metric", "AE", referenceImageFilePath, tmpFilePath, "null:"});
